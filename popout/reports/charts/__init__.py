...
CHARTS: dict[str, Any] = {
    "admixture_bar": admixture_bar,
    "boundary_localization": boundary_localization,
    "bp_confusion": bp_confusion,
    "calibration_heatmap": calibration_heatmap,
    "ccc_chrom_drift": ccc_chrom_drift,
    "ccc_chrom_stdev": ccc_chrom_stdev,
    "ccc_dose_response": ccc_dose_response,
    ...
    "panel_coverage_attribution": panel_coverage_attribution,
